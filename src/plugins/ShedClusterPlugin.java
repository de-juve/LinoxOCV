    ...
    public void run() {
        ...
        for ( int row = 0; row < image.height(); row++ ) {
            for ( int col = 0; col < image.width(); col++ ) {
                ...
                ArrayList<Point> neighbors = PixelsMentor.getNeighborhoodOfPixelWidthDiagonalCondition( col, row, image, 1 );
                ...
                while ( !queue.isEmpty() ) {
                    ...
                    if ( !analyzed[id( p.x, p.y )] ) {
                        ...
                        if ( lumn == lum ) {
                            ...
                            neighbors.clear();
                            neighbors = PixelsMentor.getNeighborhoodOfPixelWidthDiagonalCondition( p.x, p.y, image, 1 );
